...
class ScenarioController {
        ...
        if (confirm('确定要删除这个剧本吗？')) {
            try {
                ...
                if (scenario) {
                    ...
                    const coverPath = scenario.cover || '/assets/scenario_covers/default_cover.png';
    ...
    async renameScenarioCover(scenario, coverUrl, namingStrategy = 'title') {
        const DEFAULT_COVER = '/assets/scenario_covers/default_cover.png';
        ...
        // 确保只使用scenario_covers文件夹的公开资源路径
