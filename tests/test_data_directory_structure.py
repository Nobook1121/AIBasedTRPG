...
def test_public_asset_urls_are_backed_by_data_assets(tmp_path):
    ...
    assert client.get("/assets/vendor/font-awesome/css/font-awesome.min.css").status_code == 200
    assert client.get("/js/tools/diceTool.js").status_code == 200
    assert client.get("/data/tools/diceTool.ts").status_code == 404
    assert client.get("/data/tools/diceTool.js").status_code == 404
